  ...
  card.innerHTML = `
    <a href="${link}">
      <div class="flex align-middle justify-self-start items-center rounded-full bg-bg-400 \
                      border border-white/30 w-64 hover:bg-bg-300 duration-100">
        <button class="-ml-[1px] bg-bg-200 h-16 w-16 rounded-full border border-white/30 text-center leading-5">
